...
@Service
public class AdminListRemindersByOwnerUseCase {

    private final PetHealthReminderRepository reminderRepository;
    private final PetHealthMapper reminderMapper;

    public AdminListRemindersByOwnerUseCase(PetHealthReminderRepository reminderRepository,
                                            PetHealthMapper reminderMapper) {
    ...
    public PagedResponse<PetHealthReminderResponse> execute(Long ownerUserId, int page, int size) {
        var pageable = PageRequest.of(page, size);
        var paged = reminderRepository.findByOwnerUserId(ownerUserId, pageable);

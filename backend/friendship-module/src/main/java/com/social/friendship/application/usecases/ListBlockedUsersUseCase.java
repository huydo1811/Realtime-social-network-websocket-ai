...
@Service
public class ListBlockedUsersUseCase {
    private final FriendshipRepository friendshipRepository;

    public ListBlockedUsersUseCase(FriendshipRepository friendshipRepository) {
        this.friendshipRepository = friendshipRepository;
    }

    @Transactional(readOnly = true)
    public List<Friendship> execute(Long actorId) {
        return friendshipRepository.findBlockedByUser(actorId);
    }
}

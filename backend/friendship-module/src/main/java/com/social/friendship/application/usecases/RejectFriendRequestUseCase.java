...
public class RejectFriendRequestUseCase {
    ...
    public RejectFriendRequestUseCase(FriendshipRepository friendshipRepository,
    ...
    public Friendship execute(Long actorId, Long requestId) {
        ...
        friendship.reject(actorId);
        Friendship saved = friendshipRepository.save(friendship);
        springEventPublisher.publishEvent(
                eventFactory.create("friendship.request.rejected", actorId, saved.getOtherUserId(actorId), saved));
        return saved;
    }
}
